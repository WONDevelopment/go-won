...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (wondb.Database, *BlockChain, error) {
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Engine, db wondb.Database, seed int) []*types.Header {
