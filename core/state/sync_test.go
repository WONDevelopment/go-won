...
// account array.
func checkStateAccounts(t *testing.T, db wondb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db wondb.Database, root common.Hash) error {
...
func checkStateConsistency(db wondb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(wondb.Database), srcRoot)
