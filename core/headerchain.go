...
func NewHeaderChain(chainDb wondb.Database, config *params.ChainConfig, engine consensus.Engine, procInterrupt func() bool) (*HeaderChain, error) {
...
func (bc *HeaderChain) State() (*state.StateDB, error) {
