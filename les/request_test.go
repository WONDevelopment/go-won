...
type accessTestFn func(db wondb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db wondb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db wondb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db wondb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db wondb.Database, bhash common.Hash, number uint64) light.OdrRequest {
