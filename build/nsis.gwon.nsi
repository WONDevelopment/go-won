...
# 1. install gwon for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gwon
# 5. create gwon, attach and uninstall start menu entries
...
!define APPNAME "Gwon"
!define DESCRIPTION "Official Go implementation of the WorldOpenNetwork protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gwon is installed global
