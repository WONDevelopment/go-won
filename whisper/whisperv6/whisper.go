...
// Whisper represents a dark communication interface through the WorldOpenNetwork
...
// New creates a Whisper client ready to communicate through the WorldOpenNetwork P2P network.
...
// param isP2P indicates whwon the message is peer-to-peer (should not be forwarded).
