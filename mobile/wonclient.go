...
// Contains a wrapper for the WorldOpenNetwork client.
...
type WorldOpenNetworkClient struct {
	client *wonclient.Client
}

// NewEthereumClient connects a client to the given URL.
func NewEthereumClient(rawurl string) (client *WorldOpenNetworkClient, _ error) {
	rawClient, err := wonclient.Dial(rawurl)
	return &WorldOpenNetworkClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *WorldOpenNetworkClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *WorldOpenNetworkClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *WorldOpenNetworkClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *WorldOpenNetworkClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *WorldOpenNetworkClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *WorldOpenNetworkClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *WorldOpenNetworkClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *WorldOpenNetworkClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *WorldOpenNetworkClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *WorldOpenNetworkClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *WorldOpenNetworkClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *WorldOpenNetworkClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *WorldOpenNetworkClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *WorldOpenNetworkClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *WorldOpenNetworkClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *WorldOpenNetworkClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *WorldOpenNetworkClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *WorldOpenNetworkClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *WorldOpenNetworkClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *WorldOpenNetworkClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *WorldOpenNetworkClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *WorldOpenNetworkClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *WorldOpenNetworkClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *WorldOpenNetworkClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *WorldOpenNetworkClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *WorldOpenNetworkClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *WorldOpenNetworkClient) SendTransaction(ctx *Context, tx *Transaction) error {
