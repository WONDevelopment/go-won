...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db wondb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db wondb.Database) error {
...
// validVote returns whwon it makes sense to cast the specified vote in the
