...
// all blocks' seal as valid, though they still have to conform to the WorldOpenNetwork
// consensus rules.
...
// still have to conform to the WorldOpenNetwork consensus rules.
...
// they still have to conform to the WorldOpenNetwork consensus rules.
