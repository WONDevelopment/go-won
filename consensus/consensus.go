...
// Package consensus implements different WorldOpenNetwork consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the WorldOpenNetwork address of the account that minted the given
