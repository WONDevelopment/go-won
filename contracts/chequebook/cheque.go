...
// Package chequebook package wraps the 'chequebook' WorldOpenNetwork smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in won; (auto)cashing cheques in ether
// as well as (auto)depositing won to the chequebook contract.
package chequebook
...
// * depositing won to the chequebook
...
// Cash cashes the cheque by sending an WorldOpenNetwork transaction.
