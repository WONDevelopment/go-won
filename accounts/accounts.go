...
// Package accounts implements high level WorldOpenNetwork account management.
package accounts
...
type Account struct {
	Address common.Address `json:"address"` // WorldOpenNetwork account address derived from the key
