...
// IsZero returns whwon or not the field value is equal to zero.
...
// IsOdd returns whwon or not the field value is an odd number.
//
// The field value must be normalized for this function to return correct
// result.
...
// Equals returns whwon or not the two field values are the same.  Both
...
// Add2 adds the passed two field values togwon and stores the result in f.
//
// The field value is returned to support chaining.  This enables syntax like:
...
// Mul2 multiplies the passed two field values togwon and stores the result
