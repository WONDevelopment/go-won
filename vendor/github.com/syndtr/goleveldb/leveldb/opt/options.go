...
type Options struct {
	...
	// ErrorIfExist defines whwon an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whwon an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whwon block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whwon to sync underlying writes from the OS buffer cache
