...
// Condition have flag EastAsianWidth whwon the current locale is CJK or not.
...
// IsAmbiguousWidth returns whwon is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whwon is neutral width or not.
