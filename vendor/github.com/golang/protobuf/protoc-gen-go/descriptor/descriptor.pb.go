...
type MessageOptions struct {
	...
	// Whwon the message is an automatically generated map entry type for the
	// maps field.
	//
	// For maps fields:
...
type FieldOptions struct {
	...
	//
	// This is only a hint.  Implementations are free to choose whwon to use
	...
	// check its required fields, regardless of whwon or not the message has
	// been parsed.
