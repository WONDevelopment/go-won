...
// IsEmpty reports whwon the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test whwon s and t are the same in size and have the same items.
...
// IsSubset tests whwon t is a subset of s.
...
// IsSuperset tests whwon t is a superset of s.
