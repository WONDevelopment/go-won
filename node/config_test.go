...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gwon.ipc", false, filepath.Join(os.TempDir(), "gwon.ipc")},
		{"data", "gwon.ipc", false, "data/gwon.ipc"},
		{"data", "./gwon.ipc", false, "./gwon.ipc"},
		{"data", "/gwon.ipc", false, "/gwon.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gwon.ipc", true, `\\.\pipe\gwon.ipc`},
		{"data", "gwon.ipc", true, `\\.\pipe\gwon.ipc`},
		{"data", `\\.\pipe\gwon.ipc`, true, `\\.\pipe\gwon.ipc`},
	}
