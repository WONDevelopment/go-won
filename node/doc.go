...
/*
Package node sets up multi-protocol WorldOpenNetwork nodes.
...
Node also creates the shared store of encrypted WorldOpenNetwork account keys. Services can access
