...
type GlogHandler struct {
	...
	override  uint32 // Flag whwon overrides are used, atomically accessible
	backtrace uint32 // Flag whwon backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whwon this is the callsite
