...
You always want to log a player's name and whwon they're alive or dead, so when you create the player
object, you might do:
...
of whwon the player is alive or not to each log message, so that the log records will reflect the player's
