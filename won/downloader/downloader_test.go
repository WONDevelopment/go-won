...
type downloadTester struct {
	...
	stateDb wondb.Database // Database used by the tester for syncing from peers
	peerDb  wondb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = wondb.NewMemDatabase()
