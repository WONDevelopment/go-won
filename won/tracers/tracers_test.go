...
// a Gwon console and call it with a transaction hash you which to export.
...
var makeTest = function(tx, rewind) {
  ...
  var block   = won.getBlock(won.getTransaction(tx).blockHash);
  var genesis = won.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.won.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  won.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
