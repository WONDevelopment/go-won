...
func NewOracle(backend wonapi.Backend, params Config) *Oracle {
...
func (gpo *Oracle) FixedPrice() *big.Int {
	fixedGasPrice := gpo.fixedGasPrice
	if fixedGasPrice < 0 {
		fixedGasPrice = 0
	}
	gasPrice := big.NewInt(int64(fixedGasPrice))
