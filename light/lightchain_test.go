...
func makeHeaderChain(parent *types.Header, n int, db wondb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (wondb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() wondb.Database {
	return odr.db
}
